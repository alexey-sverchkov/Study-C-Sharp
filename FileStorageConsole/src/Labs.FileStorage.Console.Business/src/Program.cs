...
using System.IO;
using Labs.FileStorage.Console.Business.CommandLineParsing.Commands;
...
using Labs.FileStorage.Console.Business.PluginLoaders;
using Labs.FileStorage.Console.Business.Users;
using Labs.FileStorage.Console.Business.CommandLineParsing.InitialProgramArguments;
using Labs.FileStorage.Console.Business.Data.Files;
using Labs.FileStorage.Console.Business.Domain.Files; // TODO: temp delete it
...
namespace Labs.FileStorage.Console.Business
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           /* List<FileMetainformation> tmpList = new List<FileMetainformation>();
            DirectoryInfo di = new DirectoryInfo("../../../../Labs.FileStorage.Console.Data/users/ivan.ivanov@mail.ru");
            foreach (var file in di.GetFiles())
            {
                tmpList.Add(new FileMetainformation(file));
            }
            FileManager fm = new FileManager();
            fm.WriteMetainformationToFile(tmpList, "../../../../Labs.FileStorage.Console.Data/database/database.bin");
