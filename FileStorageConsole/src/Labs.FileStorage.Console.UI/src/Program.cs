...
using System.IO;
using Labs.FileStorage.Console.Business;
...
using Labs.FileStorage.Console.Business.Files;
using Microsoft.Extensions.Configuration;

namespace Labs.FileStorage.Console.UI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                dbManager.CreateDatabaseInstance(pathOfDatabase);
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                fileStorageManager.CreateFileStorageInstance(user, configUsersDirectoryPath, pathOfDatabase);
            }
            catch (Exception ex)
            {
                System.Console.WriteLine(ex.Message);
